...
Luminosity = BaseQuantityType('Luminosity', unit_symbol='Cd', unit_name='candela')


# Unit of information
Information = BaseQuantityType('Information', unit_symbol='B', unit_name='byte', prefices=BINARY_PREFICES + DECIMAL_PREFICES)


# Angles
PlainAngle = BaseQuantityType('PlainAngle', unit_symbol='rad', unit_name='radian')
SolidAngle = BaseQuantityType('SolidAngle', unit_symbol='sr', unit_name='steradian')
